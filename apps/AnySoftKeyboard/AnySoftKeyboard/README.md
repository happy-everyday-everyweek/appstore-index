...
- All kinds of keyboards:
  - Supporting lots of languages via external packages. E.g., English (QWERTY, Dvorak, AZERTY, Colemak, and Workman), Hebrew, Russian, Arabic, Lao, Bulgarian, Swiss, German, Swedish, Spanish, Catalan, Belarusian, Portuguese, Ukrainian and [many more](addons/languages/PACKS.mdreadme-assets/addons/languages/PACKS.md.
...
- Every Wednesday the latest _ALPHA_ will be promoted to _BETA_. This is only for supported packs. The _BETA_ channel is an open-testing group, you can subscribe to this release channel by joining the _BETA_ channel for each [addon](addons/languages/PACKS.mdreadme-assets/addons/languages/PACKS.md.
...
- [Language-Pack](addons/languages/PACKS.mdreadme-assets/addons/languages/PACKS.md add-ons in this repo.
- [Theme](addons/themes/PACKS.mdreadme-assets/addons/themes/PACKS.md add-ons in this repo.
- [Quick-Text](addons/quicktexts/PACKS.mdreadme-assets/addons/quicktexts/PACKS.md add-ons in this repo.
...
Want to develop a new feature, fix a bug, or add new language-pack? Read more [here](CONTRIBUTING.mdreadme-assets/CONTRIBUTING.md.
Contributors should adhere to the [Code of Conduct](CODE_OF_CONDUCT.mdreadme-assets/CODE_OF_CONDUCT.md document.
