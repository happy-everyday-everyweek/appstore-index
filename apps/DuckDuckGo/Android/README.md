...
Welcome to our android application. We are excited to engage the community in development, see [CONTRIBUTING.md](CONTRIBUTING.mdreadme-assets/CONTRIBUTING.md.
...
Please refer to [contributing](CONTRIBUTING.mdreadme-assets/CONTRIBUTING.md.
...
## License
DuckDuckGo android is distributed under the Apache 2.0 [license](LICENSEreadme-assets/LICENSE.
