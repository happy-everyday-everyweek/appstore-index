...
[![License](https://img.shields.io/badge/License-GPL--2.0-blue.svg)](LICENSE.txtreadme-assets/LICENSE.txt [![ownCloud OSPO](https://img.shields.io/badge/OSPO-ownCloud-blue)](https://kiteworks.com/opensource)
...
| <img src="docs_resources/filelist_device.pngreadme-assets/docs_resources/filelist_device.png> | <img src="docs_resources/photos_device.pngreadme-assets/docs_resources/photos_device.png> | <img src="docs_resources/share_device.pngreadme-assets/docs_resources/share_device.png> | <img src="docs_resources/spaces_device.pngreadme-assets/docs_resources/spaces_device.png> |
| ---------------------------------------------- | -------------------------------------------- | ------------------------------------------- | ------------------------------------------- |
...
- [CONTRIBUTING.md](CONTRIBUTING.mdreadme-assets/CONTRIBUTING.md - Contribution guidelines
...
We welcome contributions! Please read the [Contributing Guidelines](CONTRIBUTING.mdreadme-assets/CONTRIBUTING.md
and our [Code of Conduct](CODE_OF_CONDUCT.mdreadme-assets/CODE_OF_CONDUCT.md before getting started.
...
Report vulnerabilities at **<https://security.owncloud.com>** -- see [SECURITY.md](SECURITY.mdreadme-assets/SECURITY.md.

Bug bounty: [YesWeHack ownCloud Program](https://yeswehack.com/programs/owncloud-bug-bounty-program)

## License

This project is licensed under the [GPL-2.0](LICENSE.txtreadme-assets/LICENSE.txt.
