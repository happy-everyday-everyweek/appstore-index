...
Read our [Contributing Guide](CONTRIBUTING.mdreadme-assets/CONTRIBUTING.md to learn about reporting issues, contributing code, and more ways to contribute.
...
- [Coding Style](docs/coding-style.mdreadme-assets/docs/coding-style.md - guidelines and validation and auto-formatting tools
- [Pull Request Guidelines](docs/pull-request-guidelines.mdreadme-assets/docs/pull-request-guidelines.md - branch naming and how to write good pull requests
...
[GNU General Public License version 2](LICENSE.mdreadme-assets/LICENSE.md. Note: code
