...
- [Compiling for Android.](docs/getting-started-android.mdreadme-assets/docs/getting-started-android.md
    - **[If you plan to distribute on Google Play please read the end of this guide.](docs/getting-started-android.mdreadme-assets/docs/getting-started-android.md#distributing-your-app**
- [Compiling for desktop platforms.](docs/getting-started-desktop.mdreadme-assets/docs/getting-started-desktop.md
- [Compiling for iOS.](docs/getting-started-ios.mdreadme-assets/docs/getting-started-ios.md
- [Recommended changes for making your own version.](docs/recommended-changes.mdreadme-assets/docs/recommended-changes.md