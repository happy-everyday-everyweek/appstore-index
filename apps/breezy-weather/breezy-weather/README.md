<div align="center">
<br />
<img src="app/src/res_breezy/mipmap-xxxhdpi/ic_launcher_round.webpreadme-assets/app/src/res_breezy/mipmap-xxxhdpi/ic_launcher_round.webp alt="Logo" />
</div>
...
<div align="center">
    <img src="fastlane/metadata/android/en-US/images/phoneScreenshots/01-main-header-light.pngreadme-assets/fastlane/metadata/android/en-US/images/phoneScreenshots/01-main-header-light.png alt="" style="width: 300px" />
    <img src="fastlane/metadata/android/en-US/images/phoneScreenshots/02-main-header-dark.pngreadme-assets/fastlane/metadata/android/en-US/images/phoneScreenshots/02-main-header-dark.png alt="" style="width: 300px" />
    <img src="fastlane/metadata/android/en-US/images/phoneScreenshots/03-main-blocks-1.pngreadme-assets/fastlane/metadata/android/en-US/images/phoneScreenshots/03-main-blocks-1.png alt="" style="width: 300px" />
    <img src="fastlane/metadata/android/en-US/images/phoneScreenshots/04-main-blocks-2.pngreadme-assets/fastlane/metadata/android/en-US/images/phoneScreenshots/04-main-blocks-2.png alt="" style="width: 300px" />
    <img src="fastlane/metadata/android/en-US/images/phoneScreenshots/05-settings.pngreadme-assets/fastlane/metadata/android/en-US/images/phoneScreenshots/05-settings.png alt="" style="width: 300px" />
    <img src="fastlane/metadata/android/en-US/images/phoneScreenshots/06-sources.pngreadme-assets/fastlane/metadata/android/en-US/images/phoneScreenshots/06-sources.png alt="" style="width: 300px" />
    <img src="fastlane/metadata/android/en-US/images/phoneScreenshots/07-details.pngreadme-assets/fastlane/metadata/android/en-US/images/phoneScreenshots/07-details.png alt="" style="width: 300px" />
</div>
...
* [Frequently Asked Questions / Help](HELP.mdreadme-assets/HELP.md
* [Main screen explanations](docs/HOMEPAGE.mdreadme-assets/docs/HOMEPAGE.md
* [Weather sources comparison](docs/SOURCES.mdreadme-assets/docs/SOURCES.md
...
* [Contribution guide (includes a guide to create a new weather source)](CONTRIBUTING.mdreadme-assets/CONTRIBUTING.md
...
- Changes to the [background updates process](docs/UPDATES.mdreadme-assets/docs/UPDATES.md, including but not limited: options for refreshing less than every 30 minutes, every time you open the app, every time you tap on widget, every time you unlock your phone
- “Circular sky” interface: you can set a fixed light/dark background globally from Main screen settings instead.
- Publish to Google Play Store: please [check alternatives](INSTALL.mdreadme-assets/INSTALL.md
